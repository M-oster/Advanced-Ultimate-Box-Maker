...
/* [Case Feet] */
// - Kind of Case Feet
CaseFeet = 0; // [0:No Feet, 1:OnlyHoles, 2:Rubber Feet, 3:Folding Feet, 4:Folding Feet small]
...
aFP_STexts = [[1,50,43,6,"Frontpanel"],[1,4,3,3,"(0,0)"],[1,2,0,3,"------> X"],[1,0.5,2,3,"|"],[1,0.5,3,3,"|"],[1,0.5,4,3,"|"],[1,0,5,3,"Y"]];
...
// - Round Holes - [On/Off,xPos,yPos,Diam1,Diam2,Symmetric],[...]
aBP_Holes = [[1,0,0,1.0,1.0,0]];
//               L.Hole USB-con.                            R.Hole USB-con

/* [Backplate Text] */
//Text [On/off,xPos,yPos,Fontsize,"Text"],[...]
aBP_STexts = [[1,65,43,6,"Backpanel"],[1,8,3,3,"(0,0)"],[1,9,0,3,"------> X"],[1,1.5,2,3,"|"],[1,1.5,3,3,"|"],[1,1.5,4,3,"|"],[1,0.8,7,3,"Y"]];
// Round Text [On/off,xPos,yPos,Fontsize,Diameter,Arc,Start,'Text']
...
module DemoText(OnOff,Tx,Ty,Font,Size,Content,rot, HAlign="center", VAlign="baseline") {
    if (OnOff) {
        translate([Tx, Ty, 10]) {
           rotate([0,0,rot]) {
            linear_extrude(height=FontThick) {
...
if (BShell) {
    #BottomShell();
   DemoText(1,30,20,sTextFont,3,"PCBFoot1",90);
   DemoText(1,30,10+PCBWidth,sTextFont,3,"PCBFoot2",90);
   DemoText(1,40+PCBLength,20,sTextFont,3,"PCBFoot3",90);
   DemoText(1,40+PCBLength,10+PCBWidth,sTextFont,3,"PCBFoot4",90);
   
   DemoText(1,70,10,sTextFont,3,"PCBLength",0);
   DemoText(1,45+PCBLength,15+PCBWidth/2,sTextFont,3,"PCBWidth",90);
}
