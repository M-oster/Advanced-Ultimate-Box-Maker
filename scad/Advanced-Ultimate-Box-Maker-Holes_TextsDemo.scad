...
aAddHoles = [[1,54,103,3],[1,54,128,3]];
//           Add.Hole1     Add.Hole2       
...
aFP_Holes = [[1,25,37,8,8,0],[1,44,37,8,6.5,0],[1,64,37,8,6.5,1],[1,120,18,10,10,0]];
//               round hole         hole asym.        hole sym.         Level
...
aFP_SHoles = [[1,10,15,15,10,0],[1,34,15,15,8,1],[1,106,40,30,38,3]];
//               SquareHole       Hole w.Filet        Level

// - Square Holes with Recess-Margin -[ OnOff, Sx, Sy, Sl, Sw, Recess, XMargin, YMargin],[...]
aFP_SHolesRecess = [[1,9,50,29.5,18,-1.7,1.5,2.0],[1,66,17,7.0,3.0,1.8,2.7,2.0]];
//                   SquareHole w. recess inside      Hole w.Recess outside


/* [Frontplate Text] */
// - Round Text [On/Off,xPos,yPos,Fontsize,Diameter,Arc,Start,"Text"],[...]
aFP_RTexts = [[1,122,21,3,10,180,0,"1 . 2 . 3 . 4 . 5 . 6"]];
// - Text  [On/Off,xPos,yPos,Fontsize,"Text"],[...]
aFP_STexts = [[1,45,75,6,"Text/Hole-Demo"],[1,8,70,3,"Hole w.Recess inside"],[1,10,11,3.5,"Sq.Hole"],[1,33,11,3.5,"Hole Filet"],[1,55,11,3.5,"Hole w.Recess outside"],[1,23,31,3,"R.Hole"],[1,37,31,3.5,"Hole asym."],[1,60,31,3.5,"Hole sym."],[1,112,11,3.5,"Round Text"],[1,112,80,5,"Level"]];

/* [Backplate Holes] */
// - Square Holes - [On/Off,xPos,yPos,Width,Hight,Filet],[...]
aBP_SHoles = [[1,103,56,19.2,12.9,0]];
//                AC-Power-switch
...
// - Round Holes - [On/Off,xPos,yPos,Diam1,Diam2,Symmetric],[...]
aBP_Holes = [[1,USBcon_LHoleX,USBcon_HoleY,3.0,3.0,0],[1,USBcon_RHoleX,USBcon_HoleY,3.0,3.0,0]];
//               L.Hole USB-con.                            R.Hole USB-con

/* [Backplate Text] */
//Text [On/off,xPos,yPos,Fontsize,"Text"],[...]
aBP_STexts = [[1,70,58,5,"USB"]];
// Round Text [On/off,xPos,yPos,Fontsize,Diameter,Arc,Start,'Text']
aBP_RTexts = [[0,0,0,0,0,0," "]];

/* [FAN guard Settings] */
// - Fan Position Backplane - [On/Off,xPos,yPos],[...]
BP_fan_position = [1,10,8];
...
module ShowElectrParts() {
   ...
   // insert electr.parts on Frontpanel with relative values from the position-arrays
   if (FPanL) {
      /*
   ...
   // insert electr.parts on Backpanel with relative values from the position-arrays
   if (BPanL) {
...
// insert electr.parts inside the box with absolute position-values
   if (BShell) {
      /*
