...
tri_small_spades = [[spade4p8, 7.6, 0, 0,   0],
...
//                                                                               w   h   t
//
dbl_small_rocker=["dbl_small_rocker","dbl-Rocker Sw PRASA1-16F-BB0BW", 13, 19.2, 15, 21, 2, 12.8, 18.5, 11.8, 2.5,  -1, 3.8,         tri_small_spades];
...
rockers = [small_rocker, neon_indicator, dbl_small_rocker];

use <NopSCADlib/vitamins/rocker.scad>
